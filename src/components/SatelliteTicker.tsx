...
const ITEMS = [
  ...
  { label:'TRIGGER · Barmer',   value:'DROUGHT ⚠',  color:'#f85149' },
  { label:'PAYOUT · Khammam',   value:'₹8,900 ✓',  color:'#3fb950' },
...
export default function SatelliteTicker() {
  return (
    <div className="border-y border-[#21262d] bg-[#0d1117] overflow-hidden py-2.5">
      <div className="ticker-track">
        {ALL.map((item, i) => (
          <span key={i} className="flex items-center gap-2 text-xs font-mono">
            ...
            <span className="text-[#21262d] mx-2">◆</span>
          </span>
        ))}
      </div>
    </div>
